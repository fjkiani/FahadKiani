...
import { outcomesRdChat, rdChatFeatures, projectsDetails } from '../components/Projects/HealthHive/constants'; // Adjust the path as necessary
...
const RDChat = () => {
  return (
    <div className='relative z-0 bg-primary'>
      ...
      <HHFirstSection projectDetails={projectsDetails.rdChat} />
      <HHSecondSection featureData={rdChatFeatures}/>
      <HHFeatures data={outcomesRdChat}/>    
